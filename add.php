...
if(isset($_POST['submit'])) {
	...
	$query = "INSERT INTO questions(qno, question , ans2, ans3, ans4, correct_answer) VALUES ('$qno' , '$question' , '$choice2' , '$choice3' , '$choice4' , '$correct_answer') " ;
			...
			<div class="container">
				...
				<form method="post" action="">
					...
					<p>
						...
						<input type="text" name="choices2" required="">
					</p>
					<p>
					...
					<p>
						...
						<input type="text" name="coice4" required="">
					</p>
					<p>
